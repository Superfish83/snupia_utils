...
export default function GuessTheMusic() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center" style={{ marginTop: '10vh' }}>
        <Image
            src="/games/2.jpg"
            alt="game2"
            width={1080}
      ...
      <div className="flex flex-col">
        <Link href="/guessthemusic/game" className="systemBtn w-64 text-center">시작</Link>
        <button
        ...
        <Link href="/guessthemusic/ranking" className="systemBtn w-64 text-center mt-1">랭킹</Link>
      </div>
